...
(function($) {
    ...
    var EDIT_DIALOG = ".cmp-adaptiveform-starrating__editdialog",
        CHECKBOXGROUP_ASSISTPRIORITY = EDIT_DIALOG + " .cmp-adaptiveform-starrating__assistprioritycustom",
        CHECKBOXGROUP_CUSTOMTEXT = EDIT_DIALOG + " .cmp-adaptiveform-starrating__customtext",
        CHECKBOXGROUP_DATATYPE = EDIT_DIALOG + " .cmp-adaptiveform-starrating__type",
        CHECKBOXGROUP_DEFAULTVALUE = EDIT_DIALOG + " .cmp-adaptiveform-starrating__value",
